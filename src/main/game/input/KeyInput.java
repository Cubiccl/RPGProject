...
public class KeyInput implements KeyListener
{
	...
	public void keyPressed(KeyEvent e)
	{
		...
		if (this.keyPressedInstant[e.getKeyCode()] == 0) this.keyPressedInstant[e.getKeyCode()] = 2;
	}
	...
	{
		if (keyCode >= 0 && keyCode < 256) return this.keyPressedAbsolute[keyCode];
		return false;
	}
	...
	public boolean isKeyPressedInstant(int keyCode)
	{
		if (keyCode >= 0 && keyCode < 256)
		{
			...
			if (pressed) this.keyPressedInstant[keyCode] = 1;
			return pressed;
		}
		return false;
	}
